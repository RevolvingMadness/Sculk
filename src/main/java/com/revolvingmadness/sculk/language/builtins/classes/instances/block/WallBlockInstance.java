...
public class WallBlockInstance extends BuiltinClass {
    public final Identifier id;
    public final WallBlock value;

    public WallBlockInstance(Identifier id, WallBlock value) {
    ...
    public boolean equals(Object o) {
        ...
        if (!super.equals(o))
            return false;
        WallBlockInstance that = (WallBlockInstance) o;
