...
public class StairBlockInstance extends BuiltinClass {
    public final Identifier id;
    public final StairsBlock value;

    public StairBlockInstance(Identifier id, StairsBlock value) {
    ...
    public boolean equals(Object o) {
        ...
        if (!super.equals(o))
            return false;
        StairBlockInstance that = (StairBlockInstance) o;
