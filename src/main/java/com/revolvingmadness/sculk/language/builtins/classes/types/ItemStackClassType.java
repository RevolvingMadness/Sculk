...
public class ItemStackClassType extends BuiltinClassType {
    ...
    public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
        this.validateCall("init", arguments, List.of(ItemClassType.TYPE, IntegerClassType.TYPE));
    ...
    private static class Decrement extends BuiltinMethod {
        @Override
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            this.validateCall("decrement", arguments, List.of(IntegerClassType.TYPE));
    ...
    private static class Increment extends BuiltinMethod {
        @Override
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            this.validateCall("increment", arguments, List.of(IntegerClassType.TYPE));
    ...
    private static class SetCount extends BuiltinMethod {
        @Override
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            this.validateCall("setCount", arguments, List.of(IntegerClassType.TYPE));
    ...
    private static class SetDamage extends BuiltinMethod {
        @Override
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            this.validateCall("setDamage", arguments, List.of(IntegerClassType.TYPE));
    ...
    private static class SetRepairCost extends BuiltinMethod {
        @Override
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            this.validateCall("setRepairCost", arguments, List.of(IntegerClassType.TYPE));
