...
public class GameRulesType extends BuiltinType {
    public GameRulesType() {
        ...
        this.typeVariableScope.declare(true, "getDoFireTick", new GetDoFireTick());
        this.typeVariableScope.declare(true, "getDoMobGriefing", new GetDoMobGriefing());
        this.typeVariableScope.declare(true, "getKeepInventory", new GetKeepInventory());
        this.typeVariableScope.declare(true, "getDoMobSpawning", new GetDoMobSpawning());
        this.typeVariableScope.declare(true, "getDoMobLoot", new GetDoMobLoot());
        this.typeVariableScope.declare(true, "getDoTileDrops", new GetDoTileDrops());
        this.typeVariableScope.declare(true, "getDoEntityDrops", new GetDoEntityDrops());
        this.typeVariableScope.declare(true, "getCommandBlockOutput", new GetCommandBlockOutput());
        this.typeVariableScope.declare(true, "getNaturalRegeneration", new GetNaturalRegeneration());
        this.typeVariableScope.declare(true, "getDoDaylightCycle", new GetDoDaylightCycle());
        this.typeVariableScope.declare(true, "getLogAdminCommands", new GetLogAdminCommands());
        this.typeVariableScope.declare(true, "getShowDeathMessages", new GetShowDeathMessages());
        this.typeVariableScope.declare(true, "getRandomTickSpeed", new GetRandomTickSpeed());
        this.typeVariableScope.declare(true, "getSendCommandFeedback", new GetSendCommandFeedback());
        this.typeVariableScope.declare(true, "getReducedDebugInfo", new GetReducedDebugInfo());
        this.typeVariableScope.declare(true, "getSpectatorsGenerateChunks", new GetSpectatorsGenerateChunks());
        this.typeVariableScope.declare(true, "getSpawnRadius", new GetSpawnRadius());
        this.typeVariableScope.declare(true, "getDisableElytraMovementCheck", new GetDisableElytraMovementCheck());
        this.typeVariableScope.declare(true, "getMaxEntityCramming", new GetMaxEntityCramming());
        this.typeVariableScope.declare(true, "getDoWeatherCycle", new GetDoWeatherCycle());
        this.typeVariableScope.declare(true, "getDoLimitedCrafting", new GetDoLimitedCrafting());
        this.typeVariableScope.declare(true, "getMaxCommandChainLength", new GetMaxCommandChainLength());
        this.typeVariableScope.declare(true, "getCommandModificationBlockLimit", new GetCommandModificationBlockLimit());
        this.typeVariableScope.declare(true, "getAnnounceAdvancements", new GetAnnounceAdvancements());
        this.typeVariableScope.declare(true, "getDisableRaids", new GetDisableRaids());
        this.typeVariableScope.declare(true, "getDoInsomnia", new GetDoInsomnia());
        this.typeVariableScope.declare(true, "getDoImmediateRespawn", new GetDoImmediateRespawn());
        this.typeVariableScope.declare(true, "getDrowningDamage", new GetDrowningDamage());
        this.typeVariableScope.declare(true, "getFallDamage", new GetFallDamage());
        this.typeVariableScope.declare(true, "getFireDamage", new GetFireDamage());
        this.typeVariableScope.declare(true, "getFreezeDamage", new GetFreezeDamage());
        this.typeVariableScope.declare(true, "getDoPatrolSpawning", new GetDoPatrolSpawning());
        this.typeVariableScope.declare(true, "getDoTraderSpawning", new GetDoTraderSpawning());
        this.typeVariableScope.declare(true, "getDoWardenSpawning", new GetDoWardenSpawning());
        this.typeVariableScope.declare(true, "getForgiveDeadPlayers", new GetForgiveDeadPlayers());
        this.typeVariableScope.declare(true, "getUniversalAnger", new GetUniversalAnger());
        this.typeVariableScope.declare(true, "getPlayersSleepingPercentage", new GetPlayersSleepingPercentage());
        this.typeVariableScope.declare(true, "getBlockExplosionDropDecay", new GetBlockExplosionDropDecay());
        this.typeVariableScope.declare(true, "getMobExplosionDropDecay", new GetMobExplosionDropDecay());
        this.typeVariableScope.declare(true, "getTntExplosionDropDecay", new GetTntExplosionDropDecay());
        this.typeVariableScope.declare(true, "getSnowAccumulationHeight", new GetSnowAccumulationHeight());
        this.typeVariableScope.declare(true, "getWaterSourceConversion", new GetWaterSourceConversion());
        this.typeVariableScope.declare(true, "getLavaSourceConversion", new GetLavaSourceConversion());
        this.typeVariableScope.declare(true, "getGlobalSoundEvents", new GetGlobalSoundEvents());
        this.typeVariableScope.declare(true, "getDoVinesSpread", new GetDoVinesSpread());
        this.typeVariableScope.declare(true, "getEnderPearlsVanishOnDeath", new GetEnderPearlsVanishOnDeath());
        this.typeVariableScope.declare(true, "getMaxArgumentCount", new GetMaxArgumentCount());
        this.typeVariableScope.declare(true, "getMaxLoops", new GetMaxLoops());
        this.typeVariableScope.declare(true, "getScriptLogsEnabled", new GetScriptLogsEnabled());
        this.typeVariableScope.declare(true, "setDoFireTick", new SetDoFireTick());
        this.typeVariableScope.declare(true, "setDoMobGriefing", new SetDoMobGriefing());
        this.typeVariableScope.declare(true, "setKeepInventory", new SetKeepInventory());
        this.typeVariableScope.declare(true, "setDoMobSpawning", new SetDoMobSpawning());
        this.typeVariableScope.declare(true, "setDoMobLoot", new SetDoMobLoot());
        this.typeVariableScope.declare(true, "setDoTileDrops", new SetDoTileDrops());
        this.typeVariableScope.declare(true, "setDoEntityDrops", new SetDoEntityDrops());
        this.typeVariableScope.declare(true, "setCommandBlockOutput", new SetCommandBlockOutput());
        this.typeVariableScope.declare(true, "setNaturalRegeneration", new SetNaturalRegeneration());
        this.typeVariableScope.declare(true, "setDoDaylightCycle", new SetDoDaylightCycle());
        this.typeVariableScope.declare(true, "setLogAdminCommands", new SetLogAdminCommands());
        this.typeVariableScope.declare(true, "setShowDeathMessages", new SetShowDeathMessages());
        this.typeVariableScope.declare(true, "setRandomTickSpeed", new SetRandomTickSpeed());
        this.typeVariableScope.declare(true, "setSendCommandFeedback", new SetSendCommandFeedback());
        this.typeVariableScope.declare(true, "setReducedDebugInfo", new SetReducedDebugInfo());
        this.typeVariableScope.declare(true, "setSpectatorsGenerateChunks", new SetSpectatorsGenerateChunks());
        this.typeVariableScope.declare(true, "setSpawnRadius", new SetSpawnRadius());
        this.typeVariableScope.declare(true, "setDisableElytraMovementCheck", new SetDisableElytraMovementCheck());
        this.typeVariableScope.declare(true, "setMaxEntityCramming", new SetMaxEntityCramming());
        this.typeVariableScope.declare(true, "setDoWeatherCycle", new SetDoWeatherCycle());
        this.typeVariableScope.declare(true, "setDoLimitedCrafting", new SetDoLimitedCrafting());
        this.typeVariableScope.declare(true, "setMaxCommandChainLength", new SetMaxCommandChainLength());
        this.typeVariableScope.declare(true, "setCommandModificationBlockLimit", new SetCommandModificationBlockLimit());
        this.typeVariableScope.declare(true, "setAnnounceAdvancements", new SetAnnounceAdvancements());
        this.typeVariableScope.declare(true, "setDisableRaids", new SetDisableRaids());
        this.typeVariableScope.declare(true, "setDoInsomnia", new SetDoInsomnia());
        this.typeVariableScope.declare(true, "setDoImmediateRespawn", new SetDoImmediateRespawn());
        this.typeVariableScope.declare(true, "setDrowningDamage", new SetDrowningDamage());
        this.typeVariableScope.declare(true, "setFallDamage", new SetFallDamage());
        this.typeVariableScope.declare(true, "setFireDamage", new SetFireDamage());
        this.typeVariableScope.declare(true, "setFreezeDamage", new SetFreezeDamage());
        this.typeVariableScope.declare(true, "setDoPatrolSpawning", new SetDoPatrolSpawning());
        this.typeVariableScope.declare(true, "setDoTraderSpawning", new SetDoTraderSpawning());
        this.typeVariableScope.declare(true, "setDoWardenSpawning", new SetDoWardenSpawning());
        this.typeVariableScope.declare(true, "setForgiveDeadPlayers", new SetForgiveDeadPlayers());
        this.typeVariableScope.declare(true, "setUniversalAnger", new SetUniversalAnger());
        this.typeVariableScope.declare(true, "setPlayersSleepingPercentage", new SetPlayersSleepingPercentage());
        this.typeVariableScope.declare(true, "setBlockExplosionDropDecay", new SetBlockExplosionDropDecay());
        this.typeVariableScope.declare(true, "setMobExplosionDropDecay", new SetMobExplosionDropDecay());
        this.typeVariableScope.declare(true, "setTntExplosionDropDecay", new SetTntExplosionDropDecay());
        this.typeVariableScope.declare(true, "setSnowAccumulationHeight", new SetSnowAccumulationHeight());
        this.typeVariableScope.declare(true, "setWaterSourceConversion", new SetWaterSourceConversion());
        this.typeVariableScope.declare(true, "setLavaSourceConversion", new SetLavaSourceConversion());
        this.typeVariableScope.declare(true, "setGlobalSoundEvents", new SetGlobalSoundEvents());
        this.typeVariableScope.declare(true, "setDoVinesSpread", new SetDoVinesSpread());
        this.typeVariableScope.declare(true, "setEnderPearlsVanishOnDeath", new SetEnderPearlsVanishOnDeath());
        this.typeVariableScope.declare(true, "setScriptLogsEnabled", new SetScriptLogsEnabled());
        this.typeVariableScope.declare(true, "setMaxArgumentCount", new SetMaxArgumentCount());
        this.typeVariableScope.declare(true, "setMaxLoops", new SetMaxLoops());
    }
    ...
    private static class GetMaxArgumentCount extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            return new IntegerInstance(this.boundClass.toGameRules().getInt(TestingGamerules.MAX_ARGUMENTS));
        }
    }
    ...
    private static class GetMaxLoops extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            return new IntegerInstance(this.boundClass.toGameRules().getInt(TestingGamerules.MAX_LOOPS));
        }
    }
    ...
    private static class GetScriptLogsEnabled extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            return new BooleanInstance(this.boundClass.toGameRules().getBoolean(TestingGamerules.SCRIPT_LOGS_ENABLED));
        }
    }
    ...
    private static class SetAnnounceAdvancements extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.ANNOUNCE_ADVANCEMENTS).set(announceAdvancements.toBoolean(), Testing.server);
    ...
    private static class SetBlockExplosionDropDecay extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.BLOCK_EXPLOSION_DROP_DECAY).set(blockExplosionDropDecay.toBoolean(), Testing.server);
    ...
    private static class SetCommandBlockOutput extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.COMMAND_BLOCK_OUTPUT).set(commandBlockOutput.toBoolean(), Testing.server);
    ...
    private static class SetDisableElytraMovementCheck extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DISABLE_ELYTRA_MOVEMENT_CHECK).set(disableElytraMovementCheck.toBoolean(), Testing.server);
    ...
    private static class SetDisableRaids extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DISABLE_RAIDS).set(disableRaids.toBoolean(), Testing.server);
    ...
    private static class SetDoDaylightCycle extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_DAYLIGHT_CYCLE).set(doDaylightCycle.toBoolean(), Testing.server);
    ...
    private static class SetDoEntityDrops extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_ENTITY_DROPS).set(doEntityDrops.toBoolean(), Testing.server);
    ...
    private static class SetDoFireTick extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_FIRE_TICK).set(doFireTick.toBoolean(), Testing.server);
    ...
    private static class SetDoImmediateRespawn extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_IMMEDIATE_RESPAWN).set(immediateRespawn.toBoolean(), Testing.server);
    ...
    private static class SetDoInsomnia extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_INSOMNIA).set(doInsomnia.toBoolean(), Testing.server);
    ...
    private static class SetDoLimitedCrafting extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_LIMITED_CRAFTING).set(doLimitedCrafting.toBoolean(), Testing.server);
    ...
    private static class SetDoMobGriefing extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_MOB_GRIEFING).set(doMobGriefing.toBoolean(), Testing.server);
    ...
    private static class SetDoMobLoot extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_MOB_LOOT).set(doMobLoot.toBoolean(), Testing.server);
    ...
    private static class SetDoMobSpawning extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_MOB_SPAWNING).set(doMobSpawning.toBoolean(), Testing.server);
    ...
    private static class SetDoPatrolSpawning extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_PATROL_SPAWNING).set(doPatrolSpawning.toBoolean(), Testing.server);
    ...
    private static class SetDoTileDrops extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_TILE_DROPS).set(doTileDrops.toBoolean(), Testing.server);
    ...
    private static class SetDoTraderSpawning extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_TRADER_SPAWNING).set(doTraderSpawning.toBoolean(), Testing.server);
    ...
    private static class SetDoVinesSpread extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_VINES_SPREAD).set(doVinesSpread.toBoolean(), Testing.server);
    ...
    private static class SetDoWardenSpawning extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_WARDEN_SPAWNING).set(doWardenSpawning.toBoolean(), Testing.server);
    ...
    private static class SetDoWeatherCycle extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DO_WEATHER_CYCLE).set(doWeatherCycle.toBoolean(), Testing.server);
    ...
    private static class SetDrowningDamage extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.DROWNING_DAMAGE).set(drowningDamage.toBoolean(), Testing.server);
    ...
    private static class SetEnderPearlsVanishOnDeath extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.ENDER_PEARLS_VANISH_ON_DEATH).set(enderPearlsVanishOnDeath.toBoolean(), Testing.server);
    ...
    private static class SetFallDamage extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.FALL_DAMAGE).set(fallDamage.toBoolean(), Testing.server);
    ...
    private static class SetFireDamage extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.FIRE_DAMAGE).set(fireDamage.toBoolean(), Testing.server);
    ...
    private static class SetForgiveDeadPlayers extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.FORGIVE_DEAD_PLAYERS).set(forgiveDeadPlayers.toBoolean(), Testing.server);
    ...
    private static class SetFreezeDamage extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.FREEZE_DAMAGE).set(freezeDamage.toBoolean(), Testing.server);
    ...
    private static class SetGlobalSoundEvents extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.GLOBAL_SOUND_EVENTS).set(globalSoundEvents.toBoolean(), Testing.server);
    ...
    private static class SetKeepInventory extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.KEEP_INVENTORY).set(keepInventory.toBoolean(), Testing.server);
    ...
    private static class SetLavaSourceConversion extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.LAVA_SOURCE_CONVERSION).set(lavaSourceConversion.toBoolean(), Testing.server);
    ...
    private static class SetLogAdminCommands extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.LOG_ADMIN_COMMANDS).set(logAdminCommands.toBoolean(), Testing.server);
    ...
    private static class SetMobExplosionDropDecay extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.MOB_EXPLOSION_DROP_DECAY).set(mobExplosionDropDecay.toBoolean(), Testing.server);
    ...
    private static class SetNaturalRegeneration extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.NATURAL_REGENERATION).set(naturalRegeneration.toBoolean(), Testing.server);
    ...
    private static class SetReducedDebugInfo extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.REDUCED_DEBUG_INFO).set(reducedDebugInfo.toBoolean(), Testing.server);
    ...
    private static class SetScriptLogsEnabled extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(TestingGamerules.SCRIPT_LOGS_ENABLED).set(scriptLogsEnabled.toBoolean(), Testing.server);
    ...
    private static class SetSendCommandFeedback extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.SEND_COMMAND_FEEDBACK).set(sendCommandFeedback.toBoolean(), Testing.server);
    ...
    private static class SetShowDeathMessages extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.SHOW_DEATH_MESSAGES).set(showDeathMessages.toBoolean(), Testing.server);
    ...
    private static class SetSpectatorsGenerateChunks extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.SPECTATORS_GENERATE_CHUNKS).set(spectatorsGenerateChunks.toBoolean(), Testing.server);
    ...
    private static class SetTntExplosionDropDecay extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.TNT_EXPLOSION_DROP_DECAY).set(tntExplosionDropDecay.toBoolean(), Testing.server);
    ...
    private static class SetUniversalAnger extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.UNIVERSAL_ANGER).set(universalAnger.toBoolean(), Testing.server);
    ...
    private static class SetWaterSourceConversion extends BuiltinMethod {
        ...
        public BuiltinClass call(Interpreter interpreter, List<BuiltinClass> arguments) {
            ...
            this.boundClass.toGameRules().get(GameRules.WATER_SOURCE_CONVERSION).set(waterSourceConversion.toBoolean(), Testing.server);
