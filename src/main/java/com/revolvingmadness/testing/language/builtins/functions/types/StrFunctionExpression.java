...
public class StrFunctionExpression implements LiteralExpressionNode {
    public final FunctionSignature signature;

    public StrFunctionExpression() {
        this.signature = new FunctionSignature(new IdentifierExpressionNode("str"), List.of(new IdentifierExpressionNode("value")));
    }
    ...
    public LiteralExpressionNode call(ScriptNode script, List<ExpressionNode> arguments) {
        ...
        return interpretedFirstArgument.toStringType();
    }
