...
public class PlayerEntityClass extends BaseClassExpressionNode {
    ...
    public class AddExperienceLevels extends BaseClassExpressionNode {
        ...
        public BaseClassExpressionNode call(Interpreter interpreter, List<ExpressionNode> arguments) {
            ...
            BaseClassExpressionNode experienceLevels = interpreter.visitExpression(arguments.get(0));

            if (!experienceLevels.getType().equals("int")) {
    ...
    public class AddExperiencePoints extends BaseClassExpressionNode {
        ...
        public BaseClassExpressionNode call(Interpreter interpreter, List<ExpressionNode> arguments) {
            ...
            BaseClassExpressionNode experience = interpreter.visitExpression(arguments.get(0));

            if (!experience.getType().equals("int")) {
