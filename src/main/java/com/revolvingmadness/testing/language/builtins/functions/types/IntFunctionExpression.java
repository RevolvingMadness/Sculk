...
public class IntFunctionExpression implements LiteralExpressionNode {
    public final FunctionSignature signature;

    public IntFunctionExpression() {
        this.signature = new FunctionSignature(new IdentifierExpressionNode("int"), List.of(new IdentifierExpressionNode("value")));
    }
