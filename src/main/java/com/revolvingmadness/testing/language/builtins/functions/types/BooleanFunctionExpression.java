...
public class BooleanFunctionExpression implements LiteralExpressionNode {
    public final FunctionSignature signature;

    public BooleanFunctionExpression() {
        this.signature = new FunctionSignature(new IdentifierExpressionNode("boolean"), List.of(new IdentifierExpressionNode("value")));
    }
